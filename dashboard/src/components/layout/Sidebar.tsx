      ...
      <aside className="hidden md:flex flex-col items-center w-14 border-r border-border bg-card py-3 gap-1" role="navigation" aria-label="Collapsed sidebar">
        ...
        {(
          [
            ...
            { view: "sessions", icon: Terminal, label: "Code Sessions" },
            { view: "cli-monitor", icon: Monitor, label: "CLI Monitor" },
          ] as const
  ...
  return (
    ...
    <aside className="flex flex-col w-[280px] border-r border-border bg-card sidebar-mobile" role="navigation" aria-label="Main navigation">
      ...
      <div className="border-t border-border p-2 space-y-0.5">
        ...
        <NavItem icon={Terminal} view="sessions" label="Sessions de code" sublabel="Code sessions" currentView={currentView} onNavigate={onNavigate} />
        <NavItem icon={Monitor} view="cli-monitor" label="CLI Monitor" sublabel="Activity dashboard" currentView={currentView} onNavigate={onNavigate} />
